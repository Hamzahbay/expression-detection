!function (t, e) {
    ...
    function l(t) {
      t in i || (i[t] = function (e) {
        ...
        1 === e ? t.getContext('webgl', u) || t.getContext('experimental-webgl', u)  : t.getContext('webgl2', u)
      }(t));
      var e = i[t];
    ...
    function h(t) {
      for (var e = t.length, n = 0, r = 0; 0 < e; ) r = Math.random() * e | 0,
      n = t[--e],
      t[e] = t[r],
      t[r] = n
    }
    ...
    function x(t, e) {
      ...
      ]), Array.isArray(t) || z(t)) for (var n = 0; n < t.length; ++n) x(t[n], e);
       else e.push(t);
      return e
    }
    function B(t) {
    ...
    function N(t, e) {
      for (var n = 1, r = - 1, o = 0; o < t.length; ++o) if (0 <= t[o]) n *= t[o];
       else if ( - 1 === t[o]) {
    ...
    function I(t, e) {
      ...
      ], o = null == e ? null : k(e, t).sort(), i = 0, a = 0; a < t.length; ++a) {
        if (null != o) {
      ...
      s = function t(e, n, r, o, i, a) {
        ...
        if (1 === c) {
          if (rt < u) {
            ...
            return 'complex64' === r && (h = ct(h), p = ct(p)),
            [
              '[' + h.map(function (t, e) {
                return st(t, i[e], r)
        ...
        if (rt < u) {
          ...
          for (m.push('...'), g = u - ot; g < u; g++) y = (x = g * v) + v,
        ...
        var b = ',\n';
        for (g = 2; g < c; g++) b += '\n';
        return m[m.length - 1] = ' ' + m[m.length - 1] + ']' + (a ? '' : b),
        m
      }(t, e, n, o, i),
      u = [
        'Tensor'
      ];
      return r && (u.push('  dtype: ' + n), u.push('  rank: ' + a), u.push('  shape: [' + e + ']'), u.push('  values:')),
    ...
    var lt = function () {
      ...
      t.prototype.indexToLoc = function (t) {
        ...
        for (var e = new Array(this.shape.length), n = 0; n < e.length - 1; ++n) e[n] = Math.floor(t / this.strides[n]),
    ...
    var dt = function () {
          ...
          return R(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                ...
                [
                  2,
                  pt.buffer(this.shape, this.dtype, e)
                ]
            }
          })
        })
      ...
      o.prototype.batchNormalization = function (t, e, n, r, o) {
        return void 0 === n && (n = 0.001),
        ft('tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon'),
        this.batchNorm(t, e, o, r, n)
      },
      o.prototype.batchNorm = function (t, e, n, r, o) {
        return void 0 === o && (o = 0.001),
        this.throwIfDisposed(),
      ...
      o.prototype.squaredDifference = function (t) {
        return this.throwIfDisposed(),
        pt.squaredDifference(this, t)
      },
      o.prototype.squaredDifferenceStrict = function (t) {
        return this.throwIfDisposed(),
        pt.squaredDifferenceStrict(this, t)
      },
      ...
      o.prototype.conv2dTranspose = function (t, e, n, r, o) {
        return this.throwIfDisposed(),
        pt.conv2dTranspose(this, t, e, n, r, o)
      },
      ...
      o.prototype.avgPool = function (t, e, n, r) {
        return this.throwIfDisposed(),
        pt.avgPool(this, t, e, n, r)
      },
      o.prototype.maxPool = function (t, e, n, r) {
        return this.throwIfDisposed(),
        pt.maxPool(this, t, e, n, r)
      },
      ...
      o.prototype.unsortedSegmentSum = function (t, e) {
        return this.throwIfDisposed(),
        pt.unsortedSegmentSum(this, t, e)
      },
      o.prototype.batchToSpaceND = function (t, e) {
        return this.throwIfDisposed(),
        pt.batchToSpaceND(this, t, e)
      },
      o.prototype.spaceToBatchND = function (t, e) {
        return this.throwIfDisposed(),
        pt.spaceToBatchND(this, t, e)
      },
      ...
      o.prototype.depthToSpace = function (t, e) {
        return this.throwIfDisposed(),
        pt.depthToSpace(this, t, e)
      },
      o.prototype.fft = function () {
        return this.throwIfDisposed(),
        pt.spectral.fft(this)
      },
      o.prototype.ifft = function () {
        return this.throwIfDisposed(),
        pt.spectral.ifft(this)
      },
      o.prototype.rfft = function () {
        return this.throwIfDisposed(),
        pt.spectral.rfft(this)
      },
      o.prototype.irfft = function () {
        return this.throwIfDisposed(),
        pt.spectral.irfft(this)
      },
      o
    }();
    ...
    function Dt(t) {
      ...
      return function t(e, n, r) {
        if (null != e) if (e instanceof dt) n.push(e);
    ...
    Ft = function () {
      ...
      t.prototype.registerTensor = function (t, e) {
        ...
        if (this.numTensors++, 'string' === t.dtype && this.numStringTensors++, 0 === n) {
          this.numDataBuffers++;
          var r = 0;
          'complex64' !== t.dtype && 'string' !== t.dtype && (r = t.size * U(t.dtype)),
      ...
      t.prototype.memory = function () {
        ...
        0 < this.numStringTensors && (t.unreliable = !0, null == t.reasons && (t.reasons = [
      ...
      t.prototype.customGrad = function (r) {
        ...
        function () {
          for (var i, a = [
          ], t = 0; t < arguments.length; t++) a[t] = arguments[t];
      ...
      t.prototype.write = function (t, e) {
        ...
        this.backend !== n.backend && (n.backend.disposeData(t), n.backend = this.backend, this.backend.register(t, n.shape, n.dtype)),
      ...
      t.prototype.track = function (t) {
        ...
        return null != this.activeScope && (t.scopeId = this.activeScope.id, this.activeScope.track.push(t)),
        t
      },
      t.nextTensorId = 0,
      t.nextVariableId = 0,
    ...
    jt = function () {
      ...
      return t.setBackend = function (t, e) {
        ...
        Zt.engine.backend = Zt.findBackend(t),
        Zt.backendName = t
      },
      t.getBackend = function () {
        return Zt.initEngine(),
        Zt.backendName
      },
      ...
      t.prototype.evaluateFeature = function (t) {
        ...
        if ('TEST_EPSILON' === t) return 32 === this.backend.floatPrecision() ? 0.001 : 0.1;
        if ('EPSILON' === t) return 32 === this.backend.floatPrecision() ? 1e-7 : 0.0001;
        if ('PROD' === t) return !1;
      ...
      t.prototype.registerBackend = function (t, e, n) {
        var r = this;
        if (void 0 === n && (n = 1), t in this.registry) return console.warn(t + ' backend was already registered. Reusing existing backend'),
        !1;
        try {
          var o = e();
    ...
    ft = Qt;
    var Jt,
    Zt = (null == (Jt = $t()).ENV && (Jt.ENV = new jt(Gt())), ht = function () {
      return Jt.ENV.engine
    }, Jt.ENV),
    te = Object.freeze({
      EPSILON_FLOAT16: 0.0001,
    ...
    function ee(t) {
      ...
      for (var n = [
      ]; Array.isArray(e) || z(e); ) n.push(e.length),
      e = e[0];
    ...
    function re(t, e, n, r) {
      if (void 0 === r && (r = 'numeric'), t instanceof dt) return ne(r, t.dtype, e, n),
      t;
      var o = q(t);
      if ('string' !== o && 0 <= ['bool',
      'int32',
      'float32'].indexOf(r) && (o = r), ne(r, o, e, n), null == t || !z(t) && !Array.isArray(t) && 'number' != typeof t && 'boolean' != typeof t && 'string' != typeof t) {
        var i = null == t ? 'null' : t.constructor.name;
        throw new Error('Argument \'' + e + '\' passed to \'' + n + '\' must be a Tensor or TensorLike, but got \'' + i + '\'')
      }
      var a = ee(t);
      z(t) || Array.isArray(t) || (t = [
        t
      ]);
    ...
    function ie(t, e) {
      ...
      }), null == e) for (var n in e = [
      ], Zt.engine.registeredVariables) e.push(Zt.engine.registeredVariables[n]);
      var r = e.length;
    ...
    function de(t, e, n, r) {
      ...
      if (r) (o = o.concat(e.slice(0))).push(t[0] / n),
      o = o.concat(t.slice(1));
       else {
        o = o.concat(t[0]);
        for (var i = e.length, a = 0; a < i; ++a) o = o.concat([t[a + 1] / e[a],
        e[a]]);
    ...
    function we(e, t) {
      for (var n = [
      ], r = e.length, o = 0; o < r; o++) - 1 === t.indexOf(o) && n.push(e[o]);
      return [n,
      t.map(function (t) {
        return e[t]
      })]
    ...
    function be(t, e) {
      return function (t, e, n) {
        for (var r = t.length + e.length, o = [
        ], i = 0, a = 0, s = 0; s < r; s++) - 1 === n.indexOf(s) ? o.push(t[i++])  : o.push(e[a++]);
        return o
      }(t, e.map(function (t) {
        return 1
      }), e)
    ...
    function Ce(t, e) {
      ...
      for (var n = [
      ], r = 0; r < e; ++r) - 1 === t.indexOf(r) && n.push(r);
      return t.forEach(function (t) {
        return n.push(t)
      }),
      n
    ...
    function Ae(t, e, n, i, r, o, a, s, u) {
      ...
      ], p = 0; p < t.length; p++) c[p] = De(r, e, i, t, p),
      l[p] = Me(o, n, i, t, p),
    ...
    var We = Fe({
      complex_: function (t, e) {
        ...
        r = re(e, 'imag', 'complex');
        return g(n.shape, r.shape, 'real and imag shapes, ' + n.shape + ' and ' + r.shape + ', must match in call to tf.complex().'),
    ...
    function un(t, e) {
      ...
      for (var n = new Float32Array(2 * t.length), r = 0; r < n.length; r += 2) n[r] = t[r / 2],
      n[r + 1] = e[r / 2];
      return n
    }
    function cn(t, e) {
    ...
    function fn(t, e, n, r, o) {
      for (var i = e[e.length - 1], a = [
        t.length / i,
        i
      ], s = a[0], u = a[1], c = A(n, s * r), l = A('int32', s * r), h = 0; h < s; h++) {
        for (var p = h * u, f = t.subarray(p, p + u), d = [
        ], v = 0; v < f.length; v++) d.push({
          value: f[v],
          index: v
        });
        d.sort(function (t, e) {
    ...
    function xn(t, e) {
      for (var n = [
      ], r = Math.max(t.length, e.length), o = 0; o < r; o++) {
          ...
          default:
            return function (t, e) {
              for (var n = [
                Math.ceil(e[0] / 2),
                Math.ceil(e[1] / 2)
              ], r = Math.ceil(t[t.length - 1] / 2), o = r * Math.ceil(t[t.length - 2] / 2), i = o, a = '', s = 'b, r, c', u = 2; u < t.length - 1; u++) a = '\n      int b' + u + ' = index / ' + (i *= t[t.length - u - 1]) + ';\n      index -= b' + u + ' * ' + i + ';\n    ' + a,
              s = 'b' + u + ', ' + s;
    ...
    function Sn(t) {
      switch (t.shapeInfo.logicalShape.length) {
        ...
        default:
          return function (t) {
            for (var e = t.shapeInfo.logicalShape, n = e.length, r = t.name, o = 'get' + r.charAt(0).toUpperCase() + r.slice(1), i = t.shapeInfo.texShape, a = [
              Math.ceil(i[0] / 2),
              Math.ceil(i[1] / 2)
            ], s = a[0], u = a[1], c = Math.ceil(e[n - 1] / 2), l = c * Math.ceil(e[n - 2] / 2), h = 'int b, int row, int col', p = 'b * ' + l + ' + (row / 2) * ' + c + ' + (col / 2)', f = 2; f < n - 1; f++) h = 'int b' + f + ', ' + h,
            p = 'b' + f + ' * ' + (l *= e[n - f - 1]) + ' + ' + p;
    ...
    Ln = function (t, e, n, r, o, i) {
      ...
      var s = '1.0';
      null != o && (xn(t, o), this.variableNames.push('scale'), s = 'getScaleAtOutCoords()'),
      this.outputShape = t,
    ...
    Kn = function () {
      ...
      return t.prototype.getCustomSetupFunc = function (n, r) {
        var o = this;
        return function (t, e) {
          null == o.minLoc && (o.minLoc = t.getUniformLocationNoThrow(e, 'min'), o.maxLoc = t.getUniformLocationNoThrow(e, 'max')),
    ...
    gr = function () {
      ...
      return t.prototype.getCustomSetupFunc = function (n) {
        var r = this;
        return function (t, e) {
          null == r.valueLoc && (r.valueLoc = t.getUniformLocationNoThrow(e, 'value')),
    ...
    xr = function (t, e, n) {
      ...
      i = function (t, e) {
        ...
        ], i = 0; i < t.length; i++) i === e ? o.push('int(getIndices(' + r[i] + '))')  : o.push('' + r[i]);
        return o.join()
      }(t, n);
    ...
    function kr(t, e) {
      return [Math.max(1, Math.ceil(e / 2)),
    ...
    function Tr(t, e, n, r, o) {
      ...
      for (var a = r % 2 == 1, s = n % 2 == 1, u = Math.floor(r / 2), c = Math.floor(n / 2), l = Math.ceil(r / 2), h = l * Math.ceil(n / 2), p = _(n) * _(r), f = 0; f < e; f++) {
        ...
        if (a) {
          y = v + 4 * (l - 1);
          var C = d + r - 1;
          for (m = 4 * l, g = 2 * r, b = 0; b < c; ++b) o[C] = t[y],
          o[C + r] = t[y + 2],
          y += m,
          C += g
        }
        if (s) {
          for (y = v + 4 * (h - l), C = d + (n - 1) * r, E = 0; E < u; ++E) o[C++] = t[y++],
          o[C++] = t[y++],
          y += 2;
          a && (o[d + n * r - 1] = t[y])
        }
    ...
    (Er = br || (br = {
    })) [Er.UNPACKED_FLOAT16 = 0] = 'UNPACKED_FLOAT16',
    ...
    function Pr(t, e, n) {
      ...
      }), !1 === t.getShaderParameter(r, t.COMPILE_STATUS)) throw console.log(t.getShaderInfoLog(r)),
    ...
    function Fr(t, e, n) {
      ...
      if (Ar(t, e, function () {
        ...
        var n = Lr.exec(e);
        if (null == n) return console.log('Couldn\'t parse line number in error: ' + e),
        console.log(t);
        ...
        console.log(c.join('\n')),
        console.log(e.split('\n') [0]),
        console.log('%c ' + C(l[0], s), 'border:1px solid red; background-color:#e3d2d2; color:#a61717'),
        console.log(h.join('\n'))
    ...
    function Wr(t, e, n) {
      ...
      }), !1 === t.getProgramParameter(n, t.LINK_STATUS)) throw console.log(t.getProgramInfoLog(n)),
      new Error('Failed to link vertex and fragment shaders.')
    }
    function zr(t, e, n) {
      if (Ar(t, e, function () {
        return t.validateProgram(n)
      }), !1 === t.getProgramParameter(n, t.VALIDATE_STATUS)) throw console.log(t.getProgramInfoLog(n)),
    ...
    function ao(n, t) {
      ...
      var i = B(n);
      if (n.length <= 1 && i <= r) return [1,
      i];
      if (2 === n.length && n[0] <= r && n[1] <= r) return n;
      if (3 === n.length && n[0] * n[1] <= r && n[2] <= r) return [n[0] * n[1],
      n[2]];
      if (3 === n.length && n[0] <= r && n[1] * n[2] <= r) return [n[0],
      n[1] * n[2]];
      if (4 === n.length && n[0] * n[1] * n[2] <= r && n[3] <= r) return [n[0] * n[1] * n[2],
      n[3]];
      if (4 === n.length && n[0] <= r && n[1] * n[2] * n[3] <= r) return [n[0],
      n[1] * n[2] * n[3]];
      if (t) {
        var a = oo(n),
        s = 2,
        u = 2;
        return n.length && (s = (e = io(n)) [0], u = e[1]),
    ...
    function ho(t, e) {
      return Ur(t, e, new Float32Array([ - 1,
      1,
      0,
      0,
      1,
    ...
    function po(t, e) {
      return Gr(t, e, new Uint16Array([0,
      1,
      2,
      2,
      1,
    ...
    function _o(t, e, n, r, o, i, a, s) {
      ...
      1 === s.defaultNumChannels && p === i.length ? u = i : function (t, e, n) {
        ...
        for (var o = 0, i = 0; i < t.length; ++i) e[o] = t[i],
        o += n
      ...
      (function (t, e, n, r, o) {
        for (var i = r % 2 == 1, a = n % 2 == 1, s = Math.floor(r / 2), u = Math.floor(n / 2), c = Math.ceil(r / 2), l = c * Math.ceil(n / 2), h = _(n) * _(r), p = 0; p < e; p++) {
          ...
          if (i) {
            ...
            g = d + 4 * (c - 1);
            var E = 2 * r;
            for (v = 4 * c, y = 0; y < u; ++y) o[g] = t[b],
            o[g + 2] = t[b + r],
            b += E,
            g += v
          }
          if (a) {
            for (b = f + (n - 1) * r, g = d + 4 * (l - c), w = 0; w < s; ++w) o[g++] = t[b++],
            o[g++] = t[b++],
            g += 2;
            i && a && (o[d + h - 4] = t[b])
          }
    ...
    function No(t, e, n, r, o) {
      ...
      return Nr(a, s, o.downloadUnpackNumChannels),
      s
    }
    function ko(t, e, n, r, o) {
      ...
      return Nr(u, c, o.downloadUnpackNumChannels),
      c
    }
    ...
    Mo = function () {
      function t(t) {
        ...
        1 === Zt.get('WEBGL_VERSION') ? (this.textureFloatExtension = Or(this.gl, this.debug, 'OES_texture_float'), this.colorBufferFloatExtension = this.gl.getExtension('WEBGL_color_buffer_float'), Zt.get('WEBGL_RENDER_FLOAT32_ENABLED') || (this.textureHalfFloatExtension = Or(this.gl, this.debug, 'OES_texture_half_float'), this.colorBufferHalfFloatExtension = this.gl.getExtension('EXT_color_buffer_half_float')))  : this.colorBufferFloatExtension = Or(this.gl, this.debug, 'EXT_color_buffer_float'),
      ...
      t.prototype.deleteMatrixTexture = function (t) {
        var e = this;
        this.throwIfDisposed(),
        this.outputTexture === t && (Zr(this.gl, this.debug, this.framebuffer), this.outputTexture = null),
      ...
      t.prototype.createProgram = function (t) {
        ...
        this.vertexAttrsAreBound || (this.setProgram(o), this.vertexAttrsAreBound = bo(e, this.debug, this.program, this.vertexBuffer)),
        o
      },
      t.prototype.deleteProgram = function (t) {
        ...
        null != t && Ar(this.gl, this.debug, function () {
      ...
      t.prototype.setProgram = function (t) {
        ...
        this.throwIfDisposed(),
        this.program = t,
        null != this.program && this.debug && zr(this.gl, this.debug, this.program),
        Ar(this.gl, this.debug, function () {
      ...
      t.prototype.getQueryTimerExtension = function () {
        return null == this.disjointQueryTimerExtension && (this.disjointQueryTimerExtension = Or(this.gl, this.debug, 2 === Zt.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') ? 'EXT_disjoint_timer_query_webgl2' : 'EXT_disjoint_timer_query')),
          ...
          return R(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                ...
                [
                  2,
                  this.getQueryTime(n, Zt.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION'))
                ]
            }
          })
        })
      ...
      t.prototype.getQueryTime = function (t, e) {
        ...
        if (2 === e) {
          var n = this.gl;
          return n.getQueryParameter(t, n.QUERY_RESULT) / 1000000
        }
        var r = this.getQueryTimerExtensionWebGL1();
        return r.getQueryObjectEXT(t, r.QUERY_RESULT_EXT) / 1000000
      },
      t.prototype.isQueryAvailable = function (t, e) {
        if (0 === e) return !0;
        if (2 !== e) return o = (r = this.getQueryTimerExtensionWebGL1()).getQueryObjectEXT(t, r.QUERY_RESULT_AVAILABLE_EXT),
    ...
    Fo = function (t, e, n, r, o) {
      ...
      i = 0.5 === o ? 'inversesqrt(' + u + ')' : 1 === o ? '1.0/(' + u + ')' : 'exp(log(' + u + ') * float(-' + o + '));',
    ...
    Go = function (t) {
      ...
      if (0 === i) this.userCode = '\n        void main() {\n          setOutput(vec4(getA(), 0., 0., 0.));\n        }\n      ';
        ...
        u = function (t, e, n) {
          ...
          for (var r = '', o = t - 2; o < t; o++) r += n[o] + ' >= ' + e[o],
          o < t - 1 && (r += '||');
          return r
        }(i, t, a),
        c = function (t, e, n, r) {
    ...
    Ho = function (n, t, e) {
      ...
      for (var r = n.length, o = Dn(r), i = t.map(function (t) {
        ...
        return t[0] + n[e]
      }).join(','), s = mn('rc', r), u = mn('source', r), c = s[r - 1] + ' < ' + this.outputShape[r - 1], l = 1 === r ? 'source' : 'vec2(' + u.slice( - 2).join() + ')', h = [
        o + ' rc = outputLoc;',
        s[r - 1] + ' += 1;\n       if(' + c + ') {\n      ',
        1 === r ? '' : '}\n       rc = outputLoc;\n       ' + s[r - 2] + ' += 1;\n       if(' + s[r - 2] + ' < ' + this.outputShape[r - 2] + ') {',
        1 === r ? '' : '  ' + s[r - 1] + ' += 1;\n         if(' + c + ') {'
      ], p = 1 === r ? 'rc < start || rc >= end' : 'any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))', f = '', d = 0, v = 1 === r ? 2 : 4; d < v; d++) f += '\n        ' + h[d] + '\n        if (' + p + ') {\n          result[' + d + '] = float(' + e + ');\n        } else {\n          ' + o + ' source = rc - start;\n          result[' + d + '] = getChannel(getX(' + u.join() + '), ' + l + ');\n        }\n      ';
      f += 1 === r ? '} ' : '}}',
    ...
    $o = function (t, e) {
      ...
      'd'], e) + '\n      return ivec3(r, c, d);\n    }\n  \n      \n    int getFlatIndex(ivec3 coords) {\n      return round(' + function (t, e) {
        ...
        for (var n = [
        ], r = Math.floor(t.length / 4), o = t.length % 4, i = 0; i < r; i++) {
    ...
    ti = function (i, a) {
      ...
      function l(o) {
        var t = i.map(function (t, e) {
          return n = e,
          r = o,
          - 1 !== a.indexOf(n) && 1 !== i[n] ? i[n] + ' - ' + r[n] + ' - 1' : '' + r[n];
          var n,
          r
        });
    ...
    ri = function (t, e, n) {
      ...
      if (this.variableNames = [
        ...
        'a',
        'b'
      ], this.outputShape = e, 4 < n) throw Error('Where for rank ' + n + ' is not yet supported');
      if (1 === n) r = o = 'resRC';
       else {
        for (var i = [
          'resRC.x',
    ...
    ui = function () {
      ...
      return t.prototype.acquireTexture = function (t, e, n) {
        ...
        this.log(),
        o === br.PACKED_2X2_FLOAT32 ? r = this.gpgpu.createPackedMatrixTexture(t[0], t[1])  : o === br.PACKED_2X2_FLOAT16 ? r = this.gpgpu.createFloat16PackedMatrixTexture(t[0], t[1])  : o === br.UNPACKED_FLOAT32 ? r = this.gpgpu.createFloat32MatrixTexture(t[0], t[1])  : o === br.UNPACKED_FLOAT16 ? r = this.gpgpu.createFloat16MatrixTexture(t[0], t[1])  : o === br.PACKED_4X1_UNSIGNED_BYTE && (r = this.gpgpu.createUnsignedBytesMatrixTexture(t[0], t[1])),
    ...
    var hi = function (t, e) {
      ...
      i = function (t) {
        ...
        ], o = 0; o < t.length; o++) r.push('imod(' + n[o] + ', ' + t[o] + ')');
        return r.join()
      }(t);
      this.userCode = '\n      void main() {\n        ' + o + ' resRC = getOutputCoords();\n        setOutput(getA(' + i + '));\n      }\n    '
    };
    ...
    Ii = Fe({
      split_: function (t, e, n) {
        ...
        var r,
        o = re(t, 'x', 'split');
        return n = k(n, o.shape) [0],
        r = 'number' == typeof e ? (D(o.shape[n] % e == 0, function () {
    ...
    var Ai = Ti(function (t) {
      !function (t, e, n) {
        ...
        function r(t, e) {
          ...
          o.quick = o,
          r && ('object' == typeof r && i(r, n), o.state = function () {
            return i(n, {
            })
          }),
          o
      ...
      !function (t, e, n) {
        ...
        function r(t, e) {
          var n = new function (t) {
            ...
            t === (0 | t) ? e.x = t : n += t;
            for (var r = 0; r < n.length + 64; r++) e.x ^= 0 | n.charCodeAt(r),
            e.next()
          }(t),
          r = e && e.state,
          o = function () {
        ...
        function r(t, e) {
          ...
          var n = new function (t) {
            ...
            function (t, e) {
              ...
              u = 128;
              for (e === (0 | e) ? (r = e, e = null)  : (e += '\0', r = 0, u = Math.max(u, e.length)), o = 0, i = - 32; i < u; ++i) e && (r ^= e.charCodeAt((i + 32) % e.length)),
              0 === i && (a = r),
              r ^= r << 10,
              r ^= r >>> 15,
              r ^= r << 4,
              ...
              for (128 <= o && (s[127 & (e && e.length || 0)] = - 1), o = 127, i = 512; 0 < i; --i) r = s[o + 34 & 127],
              n = s[o = o + 1 & 127],
              r ^= r << 13,
              n ^= n << 17,
              r ^= r >>> 15,
      ...
      !function (t, e, n) {
        ...
        function r(t, e) {
          var n = new function (t) {
            ...
            for (var n = 0; n < e.length + 20; n++) o.b ^= 0 | e.charCodeAt(n),
            o.next()
          }(t),
          r = e && e.state,
          o = function () {
        ...
        function t(t, e, n) {
          ...
          o = x(function t(e, n) {
           ...
           : e || {
            ...
            try {
              var t;
              return c && (t = c.randomBytes) ? t = t(h)  : (t = new Uint8Array(h), (l.crypto || l.msCrypto).getRandomValues(t)),
              w(t)
            } catch (t) {
              var e = l.navigator,
              n = e && e.plugins;
          ...
          i = new function (t) {
            ...
            for (r = 0; r < h; r++) i[r] = i[o = g & o + t[r % n] + (e = i[r])],
            i[o] = e;
            (a.g = function (t) {
              for (var e, n = 0, r = a.i, o = a.j, i = a.S; t--; ) e = i[r = g & r + 1],
          ...
          a = function () {
            for (var t = i.g(p), e = d, n = 0; t < v; ) t = (t + n) * h,
            e *= h,
            n = i.g(1);
            for (; m <= t; ) t /= 2,
            e /= 2,
    ...
    Ki = Fe({
      eye_: function (t, e, n, r) {
        ...
        null == e && (e = t);
        for (var o = zi([t,
        e], r), i = t <= e ? t : e, a = 0; a < i; ++a) o.set(1, a, a);
        var s = o.toTensor().as2D(t, e);
        if (null == n) return s;
        if (1 === n.length) return ca($i(s, 0), [
          n[0],
          1,
          1
        ]);
        if (2 === n.length) return ca($i($i(s, 0), 0), [
          n[0],
          n[1],
          1,
          1
        ]);
        if (3 === n.length) return ca($i($i($i(s, 0), 0), 0), [
          n[0],
          n[1],
          n[2],
          1,
    ...
    Zi = Fe({
      pad2d_: function (t, e, n) {
        return void 0 === n && (n = 0),
        D(2 === e.length && 2 === e[0].length && 2 === e[1].length, function () {
    ...
    ta = Fe({
      pad3d_: function (t, e, n) {
        return void 0 === n && (n = 0),
        D(3 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length, function () {
          return 'Invalid number of paddings. Must be length of 2 each.'
        }),
        Qi(t, e, n)
      }
    ...
    ea = Fe({
      pad4d_: function (t, e, n) {
        return void 0 === n && (n = 0),
        D(4 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length && 2 === e[3].length, function () {
          return 'Invalid number of paddings. Must be length of 2 each.'
        }),
        Qi(t, e, n)
      }
      ...
      tile_: function (t, s) {
        ...
        Zt.engine.runKernel(function (t, e) {
          ...
          return {
            $x: function () {
              var t = nn(a);
              if (1 === a.rank) for (var e = 0; e < s[0]; ++e) t = t.add(i.slice([e * a.shape[0]], [
                a.shape[0]
              ]));
               else if (2 === a.rank) for (e = 0; e < s[0]; ++e) for (var n = 0; n < s[1]; ++n) t = t.add(i.slice([e * a.shape[0],
              n * a.shape[1]], [
                a.shape[0],
                a.shape[1]
              ]));
               else if (3 === a.rank) for (e = 0; e < s[0]; ++e) for (n = 0; n < s[1]; ++n) for (var r = 0; r < s[2]; ++r) t = t.add(i.slice([e * a.shape[0],
              n * a.shape[1],
              r * a.shape[2]], [
                a.shape[0],
                a.shape[1],
                ...
                for (e = 0; e < s[0]; ++e) for (n = 0; n < s[1]; ++n) for (r = 0; r < s[2]; ++r) for (var o = 0; o < s[3]; ++o) t = t.add(i.slice([e * a.shape[0],
                n * a.shape[1],
                r * a.shape[2],
                o * a.shape[3]], [
                  a.shape[0],
    ...
    var va = function () {
      function t(t) {
        if (this.gpgpu = t, this.pendingRead = new WeakMap, this.pendingDisposal = new WeakSet, this.dataRefCount = new WeakMap, this.lruDataGPU = [
        ], this.numBytesInGPU = 0, this.uploadWaitMs = 0, this.downloadWaitMs = 0, this.disposed = !1, Zt.get('WEBGL_VERSION') < 1) throw new Error('WebGL is not supported on this device');
        if (null == t) {
          var e = l(Zt.get('WEBGL_VERSION'));
          this.binaryCache = ((n = Zt.get('WEBGL_VERSION')) in da || (da[n] = {
          }), da[n]),
          this.gpgpu = new Mo(e),
          this.canvas = e.canvas,
          this.gpgpuCreatedLocally = !0
        } else this.binaryCache = {
        },
      ...
      t.prototype.write = function (t, e) {
        ...
        null != i && (this.releaseTexture(t, i, a, s, u, c), o.texture = null, o.texShape = null),
        o.usage = wr.UPLOAD,
        o.values = e
      },
      t.prototype.readSync = function (t) {
        ...
        return p && (l = performance.now()),
        h = 'complex64' === r ? un(o.real.dataSync(), o.imag.dataSync())  : this.getValuesFromTexture(t),
      ...
      t.prototype.read = function (S) {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            switch (t.label) {
              case 0:
                if (this.pendingRead.has(S)) return r = this.pendingRead.get(S),
                [
                  2,
                ...
                if (o = this.texData.get(S), i = o.texture, a = o.values, s = o.texShape, u = o.isPacked, c = o.shape, l = o.slice, h = o.dtype, null != l) return p = new mi(c, wi),
                ...
                if (null != a) return [2,
                this.convertAndCacheOnCPU(S)];
                if (this.pendingRead.set(S, [
                ]), !Zt.get('WEBGL_DOWNLOAD_FLOAT_ENABLED') && 2 === Zt.get('WEBGL_VERSION')) throw new Error('tensor.data() with WEBGL_DOWNLOAD_FLOAT_ENABLED=false and WEBGL_VERSION=2 not yet supported.');
                return v = s[1],
                m = s[0],
              ...
              case 1:
                return t.sent(),
                y = g instanceof WebGLTexture ? this.getValuesFromTexture(S)  : (x = B(c), u ? (w = oo(c), E = b = 1, c.length && (n = io(c), b = n[0], E = n[1]), this.gpgpu.downloadPackedMatrixFromBuffer(g, w, b, E, s[0], s[1]).subarray(0, x))  : this.gpgpu.downloadFloat32MatrixFromBuffer(g, s[0], s[1]).subarray(0, x)),
                ...
                this.pendingDisposal.has(S) && (this.pendingDisposal.delete (S), this.disposeData(S)),
                [
                  2,
                  C
                ]
      ...
      t.prototype.getValuesFromTexture = function (e) {
        ...
        if (Zt.get('WEBGL_DOWNLOAD_FLOAT_ENABLED')) {
          if (this.texData.get(e).isPacked) {
            ...
            l = 1,
            h = 1;
            return o.length && (l = (t = io(o)) [0], h = t[1]),
            this.gpgpu.downloadMatrixFromPackedTexture(a, c, l, h, s[0], s[1]).subarray(0, u)
          }
          return this.gpgpu.downloadFloat32MatrixFromOutputTexture(a, s[0], s[1]).subarray(0, u)
        }
        var p = this.makeTensorHandle(o, 'float32');
        p.size = B(o),
        this.texData.get(p.dataId).usage = wr.DOWNLOAD;
        var f = ue(function () {
          var t = new fr(o);
        ...
        return this.disposeData(p.dataId),
        v
      },
          ...
          return R(this, function (t) {
            switch (t.label) {
              case 0:
                ...
                this.activeTimers = n,
                u(),
                o = x(this.activeTimers.map(function (t) {
                  return t.query
                })).filter(function (t) {
                  return null != t
                }),
      ...
      t.prototype.endTimer = function (t) {
        return 0 < Zt.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') ? this.gpgpu.endQuery()  : t.endMs = performance.now(),
        t
      },
        ...
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            return 0 < Zt.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') ? [
              2,
              this.gpgpu.waitForQueryAndGetTime(n)
            ] : [
              2,
              (e = n).endMs - e.startMs
            ]
      ...
      t.prototype.disposeData = function (t) {
        if (!this.pendingDisposal.has(t)) if (this.pendingRead.has(t)) this.pendingDisposal.add(t);
      ...
      t.prototype.slice = function (t, e, n) {
        ...
        o = Oe(t.shape, e, n);
        if (!r && o) return this.uploadToGPU(t.dataId),
        this.shallowSlice(t, e, n);
      ...
      t.prototype.shallowSlice = function (t, e, n) {
        ...
        return this.dataRefCount.set(i.slice.origDataId, s + 1),
        o
      },
      t.prototype.stridedSlice = function (t, e, n, r, o, i, a, s, u) {
      ...
      t.prototype.multiply = function (t, e) {
        ...
        e])) return this.cpuBackend.multiply(t, e);
      ...
      t.prototype.gather = function (t, e, n) {
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.gather(t, e, n);
      ...
      t.prototype.spaceToBatchND = function (t, e, n) {
        ...
        o.push.apply(o, n);
        for (var i = 1 + e.length; i < t.shape.length; ++i) o.push([0,
        0]);
        var a = t.pad(o),
        s = de(a.shape, e, r, !1),
      ...
      t.prototype.argReducePacked = function (t, e, n) {
        ...
        return this.compileAndRun(i, s, a),
      ...
      t.prototype.unsortedSegmentSum = function (t, e, n) {
        ...
        var a = function (t, e, n) {
          for (var r = [
          ], o = t.length, i = 0; i < o; i++) i !== e ? r.push(t[i])  : r.push(n);
          return r
        }(i.shape, r, n),
        s = B([i.shape[r]]),
        u = i.as2D( - 1, s),
        ...
        return null != o && (l = l.transpose(_e(o))),
        l
      },
      t.prototype.segOpCompute = function (t, e, n, r, o) {
        ...
        l = c[0],
        h = c[1],
        p = this.makeOutputArray([l,
        h], r);
        return this.compileAndRun(u, [
          t,
          n
        ], p),
        p.shape[1] === o ? p : (n = tn(0, o).tile([a / s]), this.segOpCompute(p, e, n, r, o))
      },
      ...
      t.prototype.less = function (t, e) {
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.less(t, e);
      ...
      t.prototype.greater = function (t, e) {
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.greater(t, e);
      ...
      t.prototype.minimum = function (t, e) {
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.minimum(t, e);
      ...
      t.prototype.maximum = function (t, e) {
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.maximum(t, e);
      ...
      t.prototype.add = function (t, e) {
        ...
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.add(t, e);
        var n = kt(t.dtype, e.dtype);
      ...
      t.prototype.complexSeparableBinaryOp = function (s, u, c) {
        ...
        n = [
          [t.complexTensors.real,
          e.complexTensors.real],
          [
            t.complexTensors.imag,
      ...
      t.prototype.subtract = function (t, e) {
        ...
        if (this.shouldExecuteOnCPU([t,
        e])) return this.cpuBackend.subtract(t, e);
        var n = kt(t.dtype, e.dtype);
      ...
      t.prototype.exp = function (t) {
        var e;
        return e = Zt.get('WEBGL_PACK') ? new Ei(t.shape, xi)  : new mi(t.shape, xi),
        this.compileAndRun(e, [
          t
        ])
      },
      t.prototype.expm1 = function (t) {
      ...
      t.prototype.relu = function (t) {
        var e;
        return e = Zt.get('WEBGL_PACK') ? new Ei(t.shape, bi)  : new mi(t.shape, yi),
        this.compileAndRun(e, [
          t
        ])
      },
      ...
      t.prototype.clip = function (t, e, n) {
        var r,
        o = (r = Zt.get('WEBGL_PACK_CLIP') ? new Xn(t.shape)  : new Kn(t.shape)).getCustomSetupFunc(e, n);
        return this.compileAndRun(r, [
          t
        ], null, o)
      },
      ...
      t.prototype.depthwiseConv2D = function (t, e, n) {
        var r;
        return Zt.get('WEBGL_PACK_DEPTHWISECONV') && n.strideWidth <= 2 && n.outChannels / n.inChannels == 1 ? (r = new ur(n), this.compileAndRun(r, [
          t,
          e
        ], this.makePackedTensor(n.outShape, t.dtype)))  : (r = new sr(n), this.compileAndRun(r, [
          t,
          e
        ]))
      },
      ...
      t.prototype.maxPoolBackprop = function (t, e, n, r) {
        ...
        i = this.compileAndRun(o, [
          e
        ]),
        a = new Bo(r),
        s = this.makeOutputArray(a.outputShape, e.dtype),
        u = this.compileAndRun(a, [
          t,
          i
        ], s);
        return i.dispose(),
      ...
      t.prototype.nonMaxSuppression = function (t, e, n, r, o) {
        return fe('tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead'),
      ...
      t.prototype.compileAndRun = function (o, t, e, n, r) {
        var i = this;
        if (void 0 === r && (r = !0), null == e && (e = o.usesPackedTextures ? this.makePackedTensor(o.outputShape, t[0].dtype)  : this.makeOutputArray(o.outputShape, t[0].dtype)), 0 === e.size) return this.texData.get(e.dataId).values = A(e.dtype, 0),
        e;
        var a = t.map(function (t) {
          ...
          } else if (!!e.isPacked != !!o.usesPackedTextures) t = e.isPacked ? i.unpackTensor(t)  : i.packTensor(t),
        ...
        l = this.getAndSaveBinary(c, function () {
          return function (t, r, e, n) {
            ...
            for (var p = {
            }, f = 0; f < r.variableNames.length; f++) {
        ...
        function (a, s, t, e, n) {
          ...
          e.texData.isPacked ? a.setOutputPackedMatrixTexture(r, o[0], o[1])  : a.setOutputMatrixTexture(r, o[0], o[1]),
          a.setProgram(s.webGLProgram),
          1 === Zt.get('WEBGL_VERSION') && (null !== s.infLoc && a.gl.uniform1f(s.infLoc, 1 / 0), null !== s.nanLoc && a.gl.uniform1f(s.nanLoc, NaN)),
          t.forEach(function (t, e) {
            var n = s.program.variableNames[e],
            r = s.uniformLocations[n],
            o = s.uniformLocations['offset' + n];
            if (null != r) if (t.isUniform) if (B(t.shape) < 2) a.gl.uniform1f(r, t.uniformValues[0]);
             else {
              var i = t.uniformValues;
              i instanceof Float32Array || (i = new Float32Array(i)),
              a.gl.uniform1fv(r, i)
            } else null != t.texData.slice && null != o && a.gl.uniform1i(o, t.texData.slice.flatOffset),
        ...
        if (null == a) {
          ...
          if (n.texture = p, null != i) {
            if (u) {
              ...
              this.gpgpu.uploadMatrixToPackedTexture(p, f, d, v, h[0], h[1], ma(i))
      ...
      t.prototype.convertAndCacheOnCPU = function (t, e) {
        ...
        a = n.usage,
        s = n.isPacked;
        return null != r && (this.releaseTexture(t, r, o, a, i, s), n.texture = null, n.texShape = null, n.isPacked = !1),
        n.usage = wr.UPLOAD,
        null != e && (n.values = function (t, e) {
      ...
      t.prototype.acquireTexture = function (t, e, n, r, o) {
        return Zt.get('WEBGL_NUM_MB_BEFORE_PAGING') < Number.POSITIVE_INFINITY && this.lruDataGPU.push(t),
    ...
    function Ja(t, e, n, r, o, i) {
      ...
      return null != o && (a = re(o, 'scale', 'batchNorm')),
    ...
    function es(t, e, n, r, o, d) {
      ...
      return null != o && (i = re(o, 'scale', 'batchNorm')),
      ...
      v = 0 === s.rank || 1 === s.rank ? s.as4D(1, 1, 1, s.size)  : 2 === s.rank ? s.as4D(1, 1, s.shape[0], s.shape[1])  : 3 === s.rank ? s.as4D(1, s.shape[0], s.shape[1], s.shape[2])  : s,
      Zt.engine.runKernel(function (t, e) {
    ...
    function bs(t, e, r, o, i, a) {
      ...
      s = e,
      u = !1;
      3 === e.rank && (u = !0, s = e.as4D(1, e.shape[0], e.shape[1], e.shape[2]), n = [
        1,
        t[0],
        t[1],
        t[2]
    ...
    Ss = Fe({
      conv2d_: function (t, e, i, a, n, s, r) {
        ...
        c = o,
        l = !1;
        3 === o.rank && (l = !0, c = o.as4D(1, o.shape[0], o.shape[1], o.shape[2])),
        D(4 === c.rank, function () {
    ...
    Rs = Fe({
      conv3d_: function (t, e, o, i, n, a) {
        ...
        c = s,
        l = !1;
        4 === s.rank && (l = !0, c = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3])),
        D(5 === c.rank, function () {
          ...
          return {
            x: function () {
              return function (t, e, n, r, o) {
                ...
                a = e,
                s = !1;
                4 === e.rank && (s = !0, a = e.as5D(1, e.shape[0], e.shape[1], e.shape[2], e.shape[3]), i = [
                  1,
                  t[0],
                  t[1],
                  t[2],
    ...
    ks = Fe({
      depthwiseConv2d_: function (t, e, n, r, o, i, a) {
        ...
        c = s,
        l = !1;
        3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])),
        D(4 === c.rank, function () {
    ...
    var As = Fe({
      matMul_: function (t, e, i, a) {
        ...
        var v = r.shape.slice(0, - 2).concat([c,
        l]),
    ...
    function Ws(t, o, i, a, s, e) {
      ...
      r = n,
      u = !1;
      3 === n.rank && (u = !0, r = n.as4D(1, n.shape[0], n.shape[1], n.shape[2])),
      null == a && (a = [
        1,
        1
      ]),
        ...
        return {
          x: function () {
            return function (t, e, n, r, o, i) {
              ...
              c = a,
              l = !1;
              3 === s.rank && (l = !0, u = s.as4D(1, s.shape[0], s.shape[1], s.shape[2]), c = a.as4D(1, a.shape[0], a.shape[1], a.shape[2])),
              D(4 === c.rank, function () {
    ...
    var Hs = Fe({
      slice_: function (t, e, n) {
        ...
        r = 'number' == typeof e ? [
          e
        ].concat(new Array(i.rank - 1).fill(0))  : e.length < i.rank ? e.concat(new Array(i.rank - e.length).fill(0))  : e.slice(),
        o = (o = null == n ? new Array(i.rank).fill( - 1)  : 'number' == typeof n ? [
          n
        ].concat(new Array(i.rank - 1).fill( - 1))  : n.length < i.rank ? n.concat(new Array(i.rank - n.length).fill( - 1))  : n).map(function (t, e) {
    ...
    function Xs(e, n, r, t, o) {
      return n.rank < r.rank && (n = n.reshape(be(n.shape, t))),
    ...
    Js = Fe({
      argMax_: function (t, e) {
        ...
        var o = k(e, r.shape),
        n = Ce(o, r.rank);
        return null != n && (r = r.transpose(n), o = Se(o.length, r.rank)),
        Zt.engine.runKernel(function (t, e) {
    ...
    uu = Fe({
      equalStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in equalStrict: '),
        n.equal(r)
      }
    }),
    cu = Fe({
    ...
    hu = Fe({
      greaterEqualStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in greaterEqualStrict: '),
        n.greaterEqual(r)
      }
    }),
    pu = Fe({
      greaterStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in greaterStrict: '),
        n.greater(r)
      }
    }),
    fu = Fe({
    ...
    vu = Fe({
      lessEqualStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in lessEqualStrict: '),
        n.lessEqual(r)
      }
    }),
    mu = Fe({
      lessStrict_: function (t, e) {
        ...
        r = re(e, 'b', 'lessStrict');
        return g(n.shape, r.shape, 'Error in lessStrict: '),
        n.less(r)
      }
    }),
    gu = Fe({
    ...
    yu = Fe({
      notEqualStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in notEqualStrict: '),
        n.notEqual(r)
      }
    });
    var xu = Fe({
    ...
    bu = Fe({
      addStrict_: function (t, e) {
        ...
        r = re(e, 'b', 'addStrict');
        return g(n.shape, r.shape, 'Error in addStrict: '),
        n.add(r)
      }
    }),
    Eu = Fe({
    ...
    _u = Fe({
      divStrict_: function (t, e) {
        var n = re(t, 'a', 'div'),
        r = re(e, 'b', 'div');
        return g(n.shape, r.shape, 'Error in divideStrict: '),
        n.div(r)
      }
    }),
    Su = Fe({
    ...
    Nu = Fe({
      maximumStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in maximumStrict: '),
        n.maximum(r)
      }
    }),
    ku = Fe({
    ...
    Iu = Fe({
      minimumStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in minimumStrict: '),
        n.minimum(r)
      }
    }),
    Tu = Fe({
    ...
    Au = Fe({
      modStrict_: function (t, e) {
        ...
        r = re(e, 'b', 'modStrict');
        return g(n.shape, r.shape, 'Error in modStrict: '),
        n.mod(r)
      }
    }),
    Du = Fe({
    ...
    Mu = Fe({
      mulStrict_: function (t, e) {
        var n = re(t, 'a', 'mul'),
        r = re(e, 'b', 'mul');
        return g(n.shape, r.shape, 'Error in multiplyStrict: '),
        n.mul(r)
      }
    }),
    Ou = Fe({
      pow_: function (t, e) {
        ...
        return t = r.cast(kt(r.dtype, o.dtype)),
    ...
    Pu = Fe({
      powStrict_: function (t, e) {
        return g(t.shape, e.shape, 'Error in powStrict: '),
        t.pow(e)
      }
    }),
    Fu = Fe({
    ...
    Lu = Fe({
      squaredDifferenceStrict_: function (t, e) {
        ...
        return g(n.shape, r.shape, 'Error in squaredDifferenceStrict: '),
    ...
    Wu = Fe({
      subStrict_: function (t, e) {
        ...
        r = re(e, 'b', 'subStrict');
        return g(n.shape, r.shape, 'Error in subStrict: '),
        n.sub(r)
      }
    });
    var zu = Fe({
    ...
    Vu = Fe({
      logicalXor_: function (t, e) {
        ...
        return xn(n.shape, r.shape),
        Gu(t, e).logicalAnd(zu(t, e).logicalNot())
      }
    }),
    Hu = Fe({
      where_: function (t, e, n) {
        ...
        return g(r.shape, o.shape, 'Error in where: '),
        1 === i.rank ? D(i.shape[0] === r.shape[0], function () {
      ...
      return m(this, void 0, void 0, function () {
        ...
        return R(this, function (t) {
          switch (t.label) {
            case 0:
              return [4,
              (e = re(o, 'condition', 'whereAsync', 'bool')).data()];
            case 1:
              return n = t.sent(),
              r = fa(e.shape, n),
              o !== e && e.dispose(),
    ...
    function ec(t) {
      for (var e = [
      ], n = 0; n < t.length; ++n) for (var r = 0; r < t[n].length; ++r) e.push(t[n][r]);
      return e
    }
    var nc = Fe({
      gather_: function (t, e, g) {
        ...
        var n = function (t, e, n) {
          for (var r = t.shape[n], o = [
          ], i = 1, a = 1, s = 0; s < n; s++) o.push(t.shape[s]),
          i *= t.shape[s];
          for (s = 0; s < e.rank; s++) o.push(e.shape[s]);
          for (s = n + 1; s < t.rank; s++) o.push(t.shape[s]),
          a *= t.shape[s];
          return {
            batchSize: i,
            sliceSize: a,
    ...
    var oc = Fe({
      basicLSTMCell_: function (t, e, n, r, o, i) {
        ...
        return [w,
        w.tanh().mulStrict(x.sigmoid())]
      }
    }),
    ic = Fe({
      multiRNNCell_: function (t, e, n, r) {
        for (var o = re(e, 'data', 'multiRNNCell'), i = oe(n, 'c', 'multiRNNCell'), a = oe(r, 'h', 'multiRNNCell'), s = o, u = [
        ], c = 0; c < t.length; c++) {
          var l = t[c](s, i[c], a[c]);
          u.push(l[0]),
          u.push(l[1]),
        ...
        for (c = 0; c < u.length; c += 2) h.push(u[c]),
        p.push(u[c + 1]);
        return [h,
        p]
      }
    ...
    pc = Fe({
      rfft_: function (t) {
        ...
        u = Ue(i),
        c = s.split([a,
        e - a], s.shape.length - 1),
        l = u.split([a,
        e - a], u.shape.length - 1),
        h = t.shape.slice();
          ...
          return ae(function (t, e, n) {
            ...
            o]),
            {
              ...
              gradFunc: function (t, e) {
                ...
                return [t.reshape(o).mul(n.toFloat().sub(r.exp())),
    ...
    function Ic(r, o) {
      ...
      Zt.engine.tidy(function () {
        ...
        for (var h = r.shape[0], p = r.shape[1], f = Ki(h), d = r.clone(), v = qe([[1]], [
          1,
          1
        ]), m = v.clone(), t = p <= h ? p : h, e = function (l) {
          var t,
          e = d,
          n = m,
          r = f;
          m = (t = Zt.engine.tidy(function () {
            ...
            o = n.sub(r.mul(e)),
            i = t.div(o);
            m = 1 === i.shape[0] ? v.clone()  : v.concat(i.slice([1,
            0], [
              i.shape[0] - 1,
              i.shape[1]
            ]), 0);
            ...
            u = a.mul(m);
            d = 0 === l ? s.sub(u.matMul(m.transpose().matMul(s)))  : d.slice([0,
            0], [
              l,
              p
            ...
            return f = 0 === l ? c.sub(c.matMul(m).matMul(u.transpose()))  : f.slice([0,
            0], [
              h,
              l
    ...
    Ac = Fe({
      qr_: function (t, o) {
        ...
        return ha(t.reshape([e,
        t.shape[t.shape.length - 2],
        t.shape[t.shape.length - 1]]), 0).forEach(function (t) {
          var e = Ic(t, o),
          n = e[0],
          r = e[1];
          i.push(n),
    ...
    Pc = Fe({
      resizeNearestNeighbor_: function (t, e, r) {
        ...
        u = Zt.engine.runKernel(function (t, e) {
          return e([o]),
          t.resizeNearestNeighbor(o, a, s, r)
        }, {
          batchImages: o
        }, function (e, n) {
          return {
    ...
    Lc = function (s, u, c, l, h) {
      ...
      m(this, void 0, void 0, function () {
        ...
        return R(this, function (t) {
          switch (t.label) {
            case 0:
              return e = re(s, 'boxes', 'nonMaxSuppressionAsync'),
    ...
    var Vc = function () {
      function t() {
        this.blockSize = 48,
        this.firstUse = !0,
        Zt.get('IS_BROWSER') && (this.fromPixels2DContext = document.createElement('canvas').getContext('2d'))
      }
      ...
      t.prototype.pow = function (t, e) {
        return this.assertNotComplex([t,
        e], 'pow'),
      ...
      t.prototype.batchMatMul = function (t, e, n, r) {
        this.assertNotComplex([t,
        e], 'matMul');
        for (var o = n ? t.shape[1] : t.shape[2], i = n ? t.shape[2] : t.shape[1], a = r ? e.shape[1] : e.shape[2], s = t.shape[0], u = t.dataSync(), c = e.dataSync(), l = n ? [
          t.strides[0],
          1,
          t.strides[1]
        ] : [
          ...
          1,
          e.strides[0]
        ], v = d[0], m = d[1], g = d[2], y = i * a, x = zi([s,
        i,
        a], t.dtype), w = x.values, b = this.blockSize, E = 0; E < s; E++) for (var C = 0; C < i; C += b) for (var _ = 0; _ < a; _ += b) for (var S = 0; S < o; S += b) for (var R = Math.min(C + b, i), N = Math.min(_ + b, a), k = Math.min(S + b, o), I = C; I < R; I++) for (var T = _; T < N; T++) {
      ...
      t.prototype.unsortedSegmentSum = function (t, e, n) {
        ...
        for (var r = [
        ], o = t.rank - e.rank, i = 0; i < o; ++i) e = e.expandDims(i + 1);
        for (i = 0; i < n; ++i) {
          var a = Ve(i, 'int32'),
      ...
      t.prototype.round = function (t) {
        ...
        for (var e = t.dataSync(), n = new Float32Array(e.length), r = 0; r < e.length; ++r) {
          ...
          e[r] - o < 0.5 ? n[r] = Math.floor(e[r])  : 0.5 < e[r] - o ? n[r] = Math.ceil(e[r])  : n[r] = o % 2 == 0 ? o : o + 1
        }
        return dt.make(t.shape, {
          values: n
        })
      ...
      t.prototype.resizeBilinear = function (t, e, n, r) {
        ...
        for (var o = t.shape, i = o[0], a = o[1], s = o[2], u = o[3], c = t.dataSync(), l = new Float32Array(B([i,
        e,
        n,
        u])), h = [
          r && 1 < e ? a - 1 : a,
          ...
          r && 1 < e ? e - 1 : e,
          r && 1 < n ? n - 1 : n
        ], f = 0, d = h[0] / p[0], v = h[1] / p[1], m = 0; m < i; m++) for (var g = 0; g < e; g++) for (var y = d * g, x = Math.floor(y), w = y - x, b = Math.min(a - 1, Math.ceil(y)), E = m * t.strides[0] + x * t.strides[1], C = m * t.strides[0] + b * t.strides[1], _ = 0; _ < n; _++) for (var S = v * _, R = Math.floor(S), N = S - R, k = Math.min(s - 1, Math.ceil(S)), I = E + R * t.strides[2], T = C + R * t.strides[2], A = E + + k * t.strides[2], D = C + k * t.strides[2], M = 0; M < u; M++) {
          var O = c[I + M],
          P = c[T + M],
          F = O + (c[A + M] - O) * N,
          L = F + (P + (c[D + M] - P) * N - F) * w;
      ...
      t.prototype.resizeNearestNeighbor = function (t, e, n, r) {
        ...
        for (var o = t.shape, i = o[0], a = o[1], s = o[2], u = o[3], c = t.dataSync(), l = new Float32Array(i * e * n * u), h = [
          r && 1 < e ? a - 1 : a,
          r && 1 < n ? s - 1 : s
        ], p = [
          r && 1 < e ? e - 1 : e,
          r && 1 < n ? n - 1 : n
        ], f = h[0] / p[0], d = h[1] / p[1], v = 0, m = 0; m < i; m++) for (var g = m * t.strides[0], y = 0; y < e; y++) for (var x = f * y, w = g + Math.min(a - 1, r ? Math.round(x)  : Math.floor(x)) * t.strides[1], b = 0; b < n; b++) for (var E = d * b, C = w + Math.min(s - 1, r ? Math.round(E)  : Math.floor(E)) * t.strides[2], _ = 0; _ < u; _++) {
          var S = c[C + _];
          l[v++] = S
        }
        return Ge(l, [
      ...
      t.prototype.resizeNearestNeighborBackprop = function (t, e, n) {
        ...
        for (var r = e.shape, o = r[0], i = r[1], a = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * i * a * s), p = t.dataSync(), f = [
          n && 1 < c ? i - 1 : i,
          n && 1 < l ? a - 1 : a
        ], d = [
          n && 1 < c ? c - 1 : c,
          n && 1 < l ? l - 1 : l
        ], v = f[0] / d[0], m = f[1] / d[1], g = 1 / v, y = 1 / m, x = 2 * Math.ceil(g) + 2, w = 2 * Math.ceil(y) + 2, b = 0; b < o; b++) for (var E = b * e.strides[0], C = 0; C < i; C++) for (var _ = E + C * e.strides[1], S = Math.floor(C * g), R = Math.floor(S - x / 2), N = 0; N < a; N++) for (var k = _ + N * e.strides[2], I = Math.floor(N * y), T = Math.floor(I - w / 2), A = 0; A < s; A++) {
      ...
      t.prototype.batchNormalization = function (t, e, n, r, o, i) {
        ...
        o,
        i], 'batchNorm');
        for (var a = t.dataSync(), s = e.dataSync(), u = n.dataSync(), c = o ? o.dataSync()  : new Float32Array([1]), l = i ? i.dataSync()  : new Float32Array([0]), h = new Float32Array(a.length), p = l.length, f = c.length, d = u.length, v = s.length, m = 0, g = 0, y = 0, x = 0, w = 0; w < a.length; ++w) h[w] = l[m++] + (a[w] - s[g++]) * c[y++] / Math.sqrt(u[x++] + r),
        p <= m && (m = 0),
        v <= g && (g = 0),
        f <= y && (y = 0),
        d <= x && (x = 0);
      ...
      t.prototype.multinomial = function (t, e, n, r) {
        ...
        for (var o = e ? t : Le(t), i = o.shape[0], a = o.shape[1], s = Qe([i,
        n], 'int32'), u = s.dataSync(), c = o.dataSync(), l = 0; l < i; ++l) {
          var h = l * a,
      ...
      t.prototype.fftBatch = function (t, e) {
        for (var n = t.shape[0], r = t.shape[1], o = zi(t.shape, 'float32'), i = zi(t.shape, 'float32'), a = ze(t).as2D(n, r), s = Ue(t).as2D(n, r), u = 0; u < n; u++) for (var c = a.slice([u,
        0], [
          1,
          r
        ]), l = s.slice([u,
        0], [
          1,
          r
        ]), h = We(c, l), p = this.fftImpl(h, e).dataSync(), f = 0; f < r; f++) {
          var d = cn(p, f);
      ...
      t.prototype.fftImpl = function (t, e) {
        ...
        if (this.isExponentOf2(r)) {
          ...
          return e && (o = We(ze(o).div(Ve(r)), Ue(o).div(Ve(r)))),
          o
        }
        var i = t.dataSync(),
        a = function (t) {
          for (var e = new Float32Array(t.length / 2), n = new Float32Array(t.length / 2), r = 0; r < t.length; r += 2) e[r / 2] = t[r],
          n[r / 2] = t[r + 1];
          return {
            real: e,
            imag: n
      ...
      t.prototype.fftRadix2 = function (t, e, n) {
        ...
        o = e / 2,
        i = function (t) {
          for (var e = Math.ceil(t.length / 4), n = new Float32Array(e), r = new Float32Array(e), o = 0; o < t.length; o += 4) n[Math.floor(o / 4)] = t[o],
        ...
        s = function (t) {
          for (var e = Math.floor(t.length / 4), n = new Float32Array(e), r = new Float32Array(e), o = 2; o < t.length; o += 4) n[Math.floor(o / 4)] = t[o],
          r[Math.floor(o / 4)] = t[o + 1];
          return {
            real: n,
            imag: r
      ...
      t.prototype.broadcastedBinaryOp = function (a, s, t, u) {
        ...
        f = gn(s.shape, e),
        d = c.values;
        if (p.length + f.length === 0) for (var n = 0; n < d.length; ++n) d[n] = u(l[n % l.length], h[n % h.length]);
         else {
          var v = a.bufferSync(),
          m = s.bufferSync(),
          r = function (t) {
      ...
      t.prototype.cropAndResize = function (t, e, n, r, o, i) {
        for (var a = t.shape, s = a[0], u = a[1], c = a[2], l = a[3], h = e.shape[0], p = r[0], f = r[1], d = zi([h,
        p,
        f,
        l], t.dtype), v = e.dataSync(), m = n.dataSync(), g = t.dataSync(), y = t.strides, x = d.strides, w = 0; w < h; w++) {
          var b = 4 * w,
          E = v[b],
          C = v[b + 1],
          _ = v[b + 2],
          ...
          if (!(s <= R)) for (var N = 1 < p ? (_ - E) * (u - 1) / (p - 1)  : 0, k = 1 < f ? (S - C) * (c - 1) / (f - 1)  : 0, I = 0; I < p; I++) {
            ...
            if (T < 0 || u - 1 < T) for (var A = 0; A < f; A++) for (var D = 0; D < l; D++) {
              ...
              P = Math.ceil(T),
              F = T - O;
              for (A = 0; A < f; A++) if ((q = 1 < f ? C * (c - 1) + A * k : 0.5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) M = D + A * x[2] + I * x[1] + w * x[0],
              d.values[M] = i;
               else {
                var L = Math.floor(q),
                B = Math.ceil(q),
              ...
              var q;
              if ((q = 1 < f ? C * (c - 1) + A * k : 0.5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) M = D + A * x[2] + I * x[1] + w * x[0],
              d.values[M] = i;
               else {
                var j = Math.round(q),
                $ = Math.round(T);
      ...
      t.prototype.gatherND = function (t, e) {
        ...
        for (var c = new lt([a,
        s], t.dtype), l = e.dataSync(), h = t.dataSync(), p = 0; p < a; p++) {
          for (var f = [
          ], d = 0, v = 0; v < r; v++) {
            var m = l[p * r + v];
            d += m * u[v],
          ...
          l.onsuccess = function () {
            ...
            if (null == h) {
              ...
              e.onsuccess = function () {
                if (null == e.result) return r.close(),
    ...
    Jc.registerSaveRouter(cl),
    Jc.registerLoadRouter(cl);
    var ll = function () {
      function t() {
        this.indexedDB = al()
      }
      ...
      t.prototype.removeModel = function (u) {
        return m(this, void 0, void 0, function () {
          var n = this;
          return R(this, function (t) {
            return u = (e = u).startsWith(ul.URL_SCHEME) ? e.slice(ul.URL_SCHEME.length)  : e,
            [
              2,
              new Promise(function (a, s) {
                ...
                e.onsuccess = function () {
                  ...
                  i.onsuccess = function () {
                    if (null == i.result) return r.close(),
        ...
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            ...
            try {
              ...
              this.LS.setItem(this.keys.weightData, (e = i.weightData, $c ? Buffer.from(e).toString('base64')  : btoa(String.fromCharCode.apply(null, new Uint8Array(e))))),
      ...
      t.prototype.load = function () {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            ...
            if (n = {
            }, null == (r = JSON.parse(this.LS.getItem(this.keys.topology)))) throw new Error('In local storage, the topology of model \'' + this.modelPath + '\' is missing.');
    ...
    Jc.registerSaveRouter(bl),
    Jc.registerLoadRouter(bl);
    var El = function () {
      function t() {
      ...
      return t.prototype.listModels = function () {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            for (e = {
            }, n = pl + hl, r = hl + fl, o = 0; o < this.LS.length; ++o) (i = this.LS.key(o)).startsWith(n) && i.endsWith(r) && (a = xl(i), e[a] = JSON.parse(this.LS.getItem(i)));
            return [2,
            e]
          })
        })
      ...
      return e.prototype.save = function (s) {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            ...
            i.href = o,
            i.click(),
            null != s.weightData && ((a = null == this.weightDataAnchor ? document.createElement('a')  : this.weightDataAnchor).download = this.weightDataFileName, a.href = e, a.click()),
            [
              2,
              {
    ...
    _l = function () {
      ...
      t.prototype.checkManifestAndWeightFiles = function (t, n) {
        ...
        }, e = 0, a = t; e < a.length; e++) a[e].paths.forEach(function (t) {
          var e = Yc(t);
              ...
              case 1:
                ...
                n.forEach(function (t) {
                  ...
                  c[t].forEach(function (t) {
                    var e = jc(o.slice(t.groupOffset, t.groupOffset + t.sizeBytes), [
                      t.manifestEntry
                    ]);
    ...
    var kl = function () {
      function t(t, n) {
        if (this.DEFAULT_METHOD = 'POST', null == n && (n = {
        }), this.weightPathPrefix = n.weightPathPrefix, this.onProgress = n.onProgress, null == n.fetchFunc) {
      ...
      t.prototype.loadWeights = function (v) {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            switch (t.label) {
              case 0:
                for (o = Array.isArray(this.path) ? this.path[1] : this.path, r = n = void 0, n = (e = o).lastIndexOf('/'), r = e.lastIndexOf('?'), i = [
                  e.substring(0, n) + '/',
                  n < r ? e.substring(r)  : ''
                ], a = i[0], s = i[1], u = this.weightPathPrefix || a, c = [
                ], l = 0, h = v; l < h.length; l++) p = h[l],
    ...
    Jc.registerSaveRouter(Tl),
    Jc.registerLoadRouter(Tl);
    var Dl = function () {
      function t(t, e, n) {
          ...
          return R(this, function (t) {
            switch (t.label) {
              case 0:
                ...
                [
                  4,
                  tl.getManager(e.scheme).removeModel(e.path)
                ];
              case 1:
                return [2,
                t.sent()]
    ...
    Bl = Object.freeze({
          ...
          return R(this, function (t) {
            switch (t.label) {
              ...
              case 2:
                ...
                e.data()];
              case 3:
                for (l = t.sent(), h = 'float32' === e.dtype ? 255 : 1, p = new Uint8ClampedArray(o * r * 4), f = 0; f < r * o; ++f) g = m = v = d = void 0,
                1 === i ? (d = l[f] * h, v = l[f] * h, m = l[f] * h, g = 255)  : 3 === i ? (d = l[3 * f] * h, v = l[3 * f + 1] * h, m = l[3 * f + 2] * h, g = 255)  : 4 === i && (d = l[4 * f] * h, v = l[4 * f + 1] * h, m = l[4 * f + 2] * h, g = l[4 * f + 3] * h),
                p[0 + (y = 4 * f)] = Math.round(d),
                p[y + 1] = Math.round(v),
                p[y + 2] = Math.round(m),
                p[y + 3] = Math.round(g);
                return null != E && (E.width = o, E.height = r, x = E.getContext('2d'), w = new ImageData(p, o, r), x.putImageData(w, 0, 0)),
                e !== b && e.dispose(),
                [
                  2,
                  p
      ...
      e.register = function (t) {
        e.getMap().classNameMap[t.className] = [
          t,
          t.fromConfig
        ]
      },
    ...
    var Gl = Object.freeze({
      ...
      return null == n && (n = Zt.get('TEST_EPSILON')),
      Hl(t, 'number' == typeof e || 'boolean' == typeof e ? [
        e
      ] : e, function (t, e) {
    ...
    var jl = Object.freeze({
      ...
      e
    }(Wl); Object.defineProperty(Kl, Symbol.hasInstance, {
      value: function (t) {
      ...
      function t(t, e, n, r) {
        ...
        ue(function () {
          o.accBeta1 = Ve(e).variable(),
          o.accBeta2 = Ve(n).variable()
        }),
      ...
      function t(t, e, n, r, o) {
        ...
        ue(function () {
          i.iteration = Ve(0).variable(),
          i.accBeta1 = Ve(e).variable()
        }),
      ...
      adamax: nh.adamax,
      adam: nh.adam
    }, oh = jt.setBackend, ih = jt.getBackend, ah = jt.disposeVariables, sh = jt.memory; pt = Gc; var uh = Object.freeze({
      setBackend: oh,
      getBackend: ih,
      disposeVariables: ah,
      memory: sh,
      ...
      grad: function (i) {
        ...
        function (t, e) {
          ...
          return Zt.engine.tidy(function () {
            ...
            e = t.value,
            n = t.grads;
            return null != o && g(e.shape, o.shape, 'The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)'),
            se(n),
            n[0]
          })
        }
      ...
      grads: function (i) {
        ...
        function (t, e) {
          ...
          return Zt.engine.tidy(function () {
            ...
            e = t.value,
            n = t.grads;
            return null != o && g(e.shape, o.shape, 'The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])'),
            se(n),
            n
          })
        }
      ...
      valueAndGrads: function (r) {
        ...
        function (t, e) {
          ...
          return null != e && g(n.value.shape, e.shape, 'The shape of dy passed in valueAndGrads(f)([x1,...], dy) must match the shape returned by f([x1,...])'),
          se(n.grads),
          n
        }
      },
    ...
    var Bh, Wh, zh = {
      ...
      monkeyPatch: function (t) {
        ...
        _h.Canvas = n,
        _h.Image = o,
        _h.createCanvasElement = t.createCanvasElement || function () {
          return new n
        },
    ...
    Lh(), (Wh = Bh || (Bh = {
    })).TOP_LEFT = 'TOP_LEFT', Wh.TOP_RIGHT = 'TOP_RIGHT', Wh.BOTTOM_LEFT = 'BOTTOM_LEFT', Wh.BOTTOM_RIGHT = 'BOTTOM_RIGHT'; var Vh = function (t) {
      void 0 === t && (t = {
      });
      ...
      function r(t, e, n) {
        ...
        this.text = 'string' == typeof t ? [
          t
        ] : t instanceof r ? t.text : t,
        this.anchor = e,
      ...
      this.drawLabelOptions = new Vh(Object.assign({
      }, i, o))
    }, jh = function () {
      function t(t, e) {
        void 0 === e && (e = {
    ...
    function cp(t, e) {
      ...
      return t instanceof n ? Gh(a).putImageData(t, 0, 0)  : Gh(a).drawImage(t, 0, 0, o, i),
      a
    }
    function lp(n, r) {
    ...
    function pp(s, u) {
      return p(this, void 0, void 0, function () {
        ...
        return P(this, function (t) {
          switch (t.label) {
            case 0:
              return e = u || zh.getEnv().createCanvasElement(),
    ...
    function fp(t, e, n) {
      ...
      f = n && u < c ? p : 0,
      d = n && c < u ? p : 0;
      return Gh(l).drawImage(h, f, d, u, c),
      l
    }
    function dp(t) {
      var e = zh.getEnv(),
    ...
    var gp = function () {
      function t(t, e) {
        ...
        ], this._treatAsBatchInput = !1, this._inputDimensions = [
        ], !Array.isArray(t)) throw new Error('NetInput.constructor - expected inputs to be an Array of TResolvedNetInput or to be instanceof tf.Tensor4D, instead have ' + t);
        this._treatAsBatchInput = e,
        this._batchSize = t.length,
        t.forEach(function (t, e) {
          if (fh(t)) return o._imageTensors[e] = t,
        ...
        ue(function () {
          var t = bh(i.batchSize, 0, 1).map(function (t) {
            ...
            if (e instanceof dt) {
              ...
              return (n = mp(n, o)).shape[1] === r && n.shape[2] === r || (n = Wc.resizeBilinear(n, [
                r,
                r
              ])),
              n.as3D(r, r, 3)
    ...
    function yp(n) {
      return p(this, void 0, void 0, function () {
        ...
        return P(this, function (t) {
          switch (t.label) {
            case 0:
              if (n instanceof gp) return [2,
              n];
              if (!(r = Array.isArray(n) ? n : [
                n
              ]).length) throw new Error('toNetInput - empty array passed as input');
              return o = function (t) {
    ...
    function Tp(e, n) {
      return ue(function () {
        ...
        return t = Is(t, n.depthwise_filter, n.pointwise_filter, [
          1,
          1
        ], 'valid'),
        kp(t = xu(t, n.bias))
    ...
    var Mp = function () {
      function t(t) {
        ...
        n = e.inputSize,
        r = e.scoreThreshold;
        if (this._name = 'TinyYolov2Options', this._inputSize = n || 416, this._scoreThreshold = r || 0.5, 'number' != typeof this._inputSize || this._inputSize % 32 != 0) throw new Error(this._name + ' - expected inputSize to be a number divisible by 32');
    ...
    Op = function (n) {
      ...
      r.prototype.runTinyYolov2 = function (t, e) {
        ...
        Kh(n = Ip(n = Ip(n = Us(n, [
          ...
          1,
          1
        ], 'same'), e.conv6), e.conv7), e.conv8, 'valid', !1)
      },
      ...
      r.prototype.forwardInput = function (e, n) {
        ...
        return ue(function () {
          ...
          return t = (t = r.config.meanRgb ? Ep(t, r.config.meanRgb)  : t).div(Ve(256)),
            ...
            switch (t.label) {
              case 0:
                ...
                u = ue(function () {
                  ...
                  T.withClassScores ? Le(t.slice([0,
                  0,
                  0,
                  5], [
                    a,
              ...
              case 5:
                return g < s ? (y = Cp(f[v][m][g][0]), !M || M < y ? (x = (m + Cp(d[v][m][g][0])) / a * o, w = (v + Cp(d[v][m][g][1])) / a * i, b = Math.exp(d[v][m][g][2]) * this.config.anchors[g].x / a * o, E = Math.exp(d[v][m][g][3]) * this.config.anchors[g].y / a * i, C = x - b / 2, _ = w - E / 2, S = {
                  ...
                  4,
                  this.extractPredictedClass(h, S)
                ] : [
                  3,
                  7
                ])  : [
          ...
          return P(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                ...
                [
                  2,
                  Array(this.config.classes.length).fill(0).map(function (t, e) {
                    return i[n][r][o][e]
                  }).map(function (t, e) {
                    return {
                      classScore: t,
    ...
    function Up(r, o, i) {
      return void 0 === i && (i = !1),
      ue(function () {
        var t = Xu(i ? xu(Ss(r, o.conv0.filters, [
          2,
          2
        ], 'same'), o.conv0.bias)  : zp(r, o.conv0, [
          2,
          2
        ])),
        e = zp(t, o.conv1, [
    ...
    function Gp(o, i, a, s) {
      ...
      void 0 === s && (s = !0),
      ue(function () {
        var t = Xu(a ? xu(Ss(o, i.conv0.filters, s ? [
          2,
          2
        ] : [
          1,
          1
        ], 'same'), i.conv0.bias)  : zp(o, i.conv0, s ? [
          2,
          2
        ] : [
          1,
        ...
        n = zp(Xu(xu(t, e)), i.conv2, [
          1,
          1
        ]),
        r = zp(Xu(xu(t, xu(e, n))), i.conv3, [
          1,
          1
        ]);
    ...
    var jp = function (t) {
      ...
      e.prototype.forwardInput = function (e) {
        ...
        return ue(function () {
          var t = Gp(Ep(e.toBatchTensor(112, !0), [
            122.782,
            117.001,
            104.298
          ]).div(Ve(255)), n.dense0, !0);
          return t = Gp(t = Gp(t = Gp(t, n.dense1), n.dense2), n.dense3),
          t = Gs(t, [
            7,
            7
          ], [
    ...
    var Xp = function (r) {
      ...
      t.prototype.extractParamsFromWeigthMap = function (t) {
        ...
        u = a.classifierMap;
        return this.faceFeatureExtractor.loadFromWeightMap(s),
        o = ep(e = u, r = [
        ]),
        i = {
          fc: (n = 'fc', {
    ...
    Jp = function (e) {
          ...
          return P(this, function (t) {
            switch (t.label) {
              ...
              case 2:
                ...
                [
                  4,
                  Promise.all(ha(n).map(function (n) {
      ...
      var ef = function () {
        ...
        t.prototype.alignMinBbox = function (t) {
          ...
          a,
          s,
          u = (e = this.positions, n = e.map(function (t) {
            return t.x
          }), r = e.map(function (t) {
            return t.y
      ...
      function pf(t, e, n) {
        void 0 === n && (n = !0);
        var r = n ? Xu(t)  : t;
        return r = zp(r, e.separable_conv0, [
          1,
          1
        ]),
        r = zp(Xu(r), e.separable_conv1, [
          1,
          1
        ]),
        r = Us(r, [
      ...
      df = function (n) {
        ...
        t.prototype.forwardInput = function (e) {
          ...
          return ue(function () {
            ...
            o = Xu(hf(t, i.entry_flow.conv_in, [
              2,
              2
            ]));
            return o = pf(o = pf(o, i.entry_flow.reduction_block_0, !1), i.entry_flow.reduction_block_1),
            bh(n._numMainBlocks, 0, 1).forEach(function (t) {
              ...
              r = zp(Xu(e), n.separable_conv0, [
                1,
                1
              ]),
              r = zp(Xu(r), n.separable_conv1, [
                1,
                1
              ]),
              r = zp(Xu(r), n.separable_conv2, [
                1,
                1
              ]),
              o = r = xu(r, e)
            ...
            o = Xu(zp(o, i.exit_flow.separable_conv, [
              1,
              1
            ]))
          })
      ...
      var vf = function (n) {
        function t(t) {
          ...
          return e._faceFeatureExtractor = t,
          e
        }
        return a(t, n),
        Object.defineProperty(t.prototype, 'faceFeatureExtractor', {
        ...
        t.prototype.predictAgeAndGender = function (s) {
          return p(this, void 0, void 0, function () {
                      ...
                      return p(u, void 0, void 0, function () {
                        ...
                        return P(this, function (t) {
                          switch (t.label) {
                            ...
                            case 2:
                              return n = t.sent() [0],
                              o = (r = 0.5 < n) ? c.Gender.MALE : c.Gender.FEMALE,
                              i = r ? n : 1 - n,
                              a.dispose(),
                              s.dispose(),
                              [
            ...
            return this.faceFeatureExtractor.extractWeights(e),
                ...
                case 5:
                  ...
                  [
                    ...
                    u.map(function (t) {
                      ...
                      return Gh(i).putImageData(a.getImageData(e, n, r, o), 0, 0),
                      i
                    })
                  ]
              }
        ...
        var bf = function (t) {
          ...
          e.prototype.postProcess = function (t, o, e) {
            ...
            return ue(function () {
              ...
              return t.mul(Je([a,
              136], o)).sub(ua(Array.from(Array(a), function (t, e) {
              ...
              return P(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    [
                      4,
                      Promise.all(e.map(function (a, s) {
                          ...
                          return P(this, function (t) {
                            switch (t.label) {
                              ...
                              case 1:
                                ...
                                [
                                  2,
                                  new nf(Array(68).fill(0).map(function (t, e) {
          ...
          var Cf = function (t) {
            ...
            e.prototype.forwardInput = function (e) {
              ...
              return ue(function () {
                var t = Up(Ep(e.toBatchTensor(112, !0), [
                  122.782,
                  117.001,
                  104.298
                ]).div(Ve(255)), n.dense0, !0);
                return t = Up(t = Up(t, n.dense1), n.dense2),
                t = Gs(t, [
                  14,
                  14
                ], [
          ...
          function Af(t, e) {
            var n,
            r,
            o = (n = t, r = e.conv1, Rf(n, r, [
              1,
              1
            ], !0));
            return o = Nf(o, e.conv2),
            o = xu(o, t),
            o = Xu(o)
          }
          function Df(t, e) {
          ...
          var Mf = function (t) {
            ...
            e.prototype.forwardInput = function (n) {
              ...
              return ue(function () {
                var t = kf(Ep(n.toBatchTensor(150, !0).toFloat(), [
                  122.782,
                  117.001,
                  104.298
                ]).div(Ve(256)), r.conv32_down),
                e = (t = Df(t = Af(t = Af(t = Df(t = Af(t = Af(t = Df(t = Af(t = Af(t = Af(t = Df(t = Af(t = Af(t = Af(t = Us(t, 3, 2, 'valid'), r.conv32_1), r.conv32_2), r.conv32_3), r.conv64_down), r.conv64_1), r.conv64_2), r.conv64_3), r.conv128_down), r.conv128_1), r.conv128_2), r.conv256_down), r.conv256_1), r.conv256_2), r.conv256_down_out)).mean([1,
                2]);
                return As(e, r.fc)
              })
            },
          ...
          var Pf = function () {
            function t(t) {
              ...
              i = e.scoreThresholds,
              a = e.scaleSteps;
              if (this._name = 'MtcnnOptions', this._minFaceSize = n || 20, this._scaleFactor = r || 0.709, this._maxNumScales = o || 10, this._scoreThresholds = i || [
                0.6,
                0.7,
                0.7
              ], this._scaleSteps = a, 'number' != typeof this._minFaceSize || this._minFaceSize < 0) throw new Error(this._name + ' - expected minFaceSize to be a number > 0');
          ...
          function Ff(l, h) {
            ...
            function t(t, e, n) {
              ...
              c;
              return {
                depthwise_conv: (o = n + '/depthwise_conv', i = $e(l(9 * (r = t)), [
                  3,
                  3,
                  r,
                  1
                ]), a = He(l(r)), s = He(l(r)), u = He(l(r)), c = He(l(r)), h.push({
                  paramPath: o + '/filters'
                }, {
          ...
          function Bf(e, n, r) {
            return ue(function () {
              ...
              return t = xu(t, n.batch_norm_offset),
              Sa(t, 0, 6)
            })
          }
          ...
          function zf(t, e) {
            return ue(function () {
              ...
              e.conv_11,
              e.conv_12,
              e.conv_13].forEach(function (t, e) {
                var n,
                r,
                o,
                i,
                ...
                c = Bf(c = ue(function () {
                  ...
                  return t = us(t, o.batch_norm_mean, o.batch_norm_variance, o.batch_norm_offset, o.batch_norm_scale, Wf),
                  Sa(t, 0, 6)
                }), t.pointwise_conv, [
                  1,
                  1
          ...
          function Vf(e, n) {
            return ue(function () {
              ...
              return {
                ...
                classPrediction: ia(Kh(e, n.class_predictor), [
                  t,
                  - 1,
                  3
                ])
          ...
          var Hf = function () {
            function t(t) {
              ...
              n = e.minConfidence,
              r = e.maxResults;
              if (this._name = 'SsdMobilenetv1Options', this._minConfidence = n || 0.5, this._maxResults = r || 100, 'number' != typeof this._minConfidence || this._minConfidence <= 0 || 1 <= this._minConfidence) throw new Error(this._name + ' - expected minConfidence to be a number between 0 and 1');
            ...
            e.prototype.forwardInput = function (u) {
              ...
              return ue(function () {
                ...
                n = (l = e.out, h = e.conv11, p = c.prediction_layer, ue(function () {
                  ...
                  return {
                    boxPredictions: _i([o.boxPredictionEncoding,
                    i.boxPredictionEncoding,
                    a.boxPredictionEncoding,
                    s.boxPredictionEncoding,
                    u.boxPredictionEncoding,
                    c.boxPredictionEncoding], 1),
                    classPredictions: _i([o.classPrediction,
                    i.classPrediction,
                    a.classPrediction,
                    s.classPrediction,
                    u.classPrediction,
              ...
              p(this, void 0, void 0, function () {
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      for (f = t.sent(), d = this.forwardInput(f), v = d.boxes, m = d.scores, g = v[0], y = m[0], x = 1; x < v.length; x++) v[x].dispose(),
                      m[x].dispose();
          ...
          function ad(e, n, r) {
            ...
            ue(function () {
              ...
              t = id(t = Kh(t = Us(t, r ? [
                ...
                2,
                2
              ], 'same'), n.conv2, 'valid'), n.prelu2_alpha),
              t = id(t = Kh(t = r ? t : Us(t, [
                3,
                3
              ], [
                2,
                2
              ], 'valid'), n.conv3, 'valid'), n.prelu3_alpha)
            })
          }
          function sd(h, t, u, p, c) {
            ...
            var e = t.map(function (l) {
              ...
              i = function (t, o, i, e) {
                for (var n = [
                ], a = t.arraySync(), r = 0; r < t.shape[0]; r++) for (var s = 0; s < t.shape[1]; s++) a[r][s] >= e && n.push(new lh(s, r));
                ...
                switch (t.label) {
                      ...
                      Promise.all(r.map(function (c) {
                        return p(n, void 0, void 0, function () {
                          ...
                          return P(this, function (t) {
                            ...
                            [
                              2,
                              zh.isNodejs() ? cp(u)  : createImageBitmap(u)
                            ]
                          })
                        })
                      }))
                  ...
                  case 1:
                    ...
                    e.forEach(function (t) {
                      ...
                      for (var n = e.getImageData(0, 0, a, s).data, r = [
                      ], o = 0; o < n.length; o += 4) r.push(n[o + 2]),
                      r.push(n[o + 1]),
                      r.push(n[o]);
                      i.push(r)
                    }),
                ...
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    r = n.map(function (t) {
                      var a,
                      s,
                      e = (a = t, s = y, ue(function () {
                        var t = ad(a, s),
                        e = id($p(ia(t, [
                          t.shape[0],
                          s.fc1.weights.shape[0]
                        ]), s.fc1), s.prelu4_alpha),
                        n = $p(e, s.fc2_1),
                        r = $i(eu(n, 1), 1),
                        o = Le(Bu(n, r), 1),
                        i = $p(e, s.fc2_2);
                    ...
                    o = 1 < r.length ? _i(r.map(function (t) {
                      return t.scores
                    }))  : r[0].scores,
                    s = (a = Array).from,
                    [
                  ...
                  case 2:
                    ...
                    0 < c.length && (e = Date.now(), f = bp(c, l, 0.7), x.stage2_nms = Date.now() - e, d = f.map(function (t) {
              ...
              return P(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    i = n.map(function (t) {
                      ...
                      e = (s = t, u = x, ue(function () {
                        ...
                        t = id(t = Kh(t = Us(t, [
                          ...
                          2,
                          2
                        ], 'same'), u.conv4, 'valid'), u.prelu4_alpha);
                        var e = id($p(ia(t, [
                          t.shape[0],
                          u.fc1.weights.shape[0]
                        ]), u.fc1), u.prelu5_alpha),
                        n = $p(e, u.fc2_1),
                        r = $i(eu(n, 1), 1),
                        o = Le(Bu(n, r), 1),
                        i = $p(e, u.fc2_2),
                    ...
                    r = 1 < i.length ? _i(i.map(function (t) {
                      return t.scores
                    }))  : i[0].scores,
                    s = (a = Array).from,
                    [
                  ...
                  case 2:
                    ...
                    0 < l.length && (e = Date.now(), v = bp(l, h, 0.7, !1), w.stage3_nms = Date.now() - e, p = v.map(function (t) {
                      return l[t]
                    }), f = v.map(function (t) {
                      return h[t]
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    case 0:
                      ...
                      o = Date.now(),
                      i = ue(function () {
                        return t = $i(Bl.fromPixels(n)).toFloat(),
                        ue(function () {
                      ...
                      v = l.scaleSteps,
                      m = (v || function (t, e, n) {
                        for (var r = n[0], o = n[1], i = Zf / t, a = [
                        ], s = Math.min(r, o) * i, u = 0; 12 <= s; ) a.push(i * Math.pow(e, u)),
                        s *= e,
                        u += 1;
                        return a
                      }(h, p, [
                    ...
                    case 1:
                      ...
                      y.boxes.length ? (r.stage2_numInputBoxes = y.boxes.length, g = Date.now(), [
                        4,
                        cd(n, y.boxes, d[1], e.rnet, r)
                      ])  : [
                        2,
                        a({
                          results: [
                    ...
                    case 2:
                      ...
                      x.boxes.length ? (r.stage3_numInputBoxes = x.boxes.length, g = Date.now(), [
                        4,
                        ld(n, x.boxes, d[2], e.onet, r)
                      ])  : [
                        2,
                        a({
                          results: [
                    ...
                    case 3:
                      ...
                      b = w.boxes.map(function (e, t) {
                        return of(Wp({
                        }, new Lp(w.scores[t], new Th(e.left / c, e.top / u, e.width / c, e.height / u), {
                          height: u,
                          width: c
              ...
              return p(this, void 0, void 0, function () {
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      return [4,
                      Yf(e = t.sent(), this.input, function (e) {
                        return p(r, void 0, void 0, function () {
                          return P(this, function (t) {
                            switch (t.label) {
                              case 0:
              ...
              return p(this, void 0, void 0, function () {
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      return [4,
                      Yf(n = t.sent(), this.input, function (t) {
                        return Promise.all(t.map(function (t) {
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    case 0:
                      ...
                      this.parentTask];
                    case 1:
                      return (e = t.sent()) ? (n = e.detection, this.input instanceof dt ? [
                        4,
                        wf(this.input, [
                          n
                        ])
                    ...
                    case 5:
                      ...
                      [
                        4,
                        this.landmarkNet.detectLandmarks(r[0])
                      ];
                    case 6:
                      return i = t.sent(),
                      r.forEach(function (t) {
              ...
              return p(this, void 0, void 0, function () {
                ...
                return P(this, function (t) {
                  switch (t.label) {
                    case 0:
                      return [4,
                      new qd(this.input, this.options)];
                    case 1:
                      return e = t.sent(),
                      n = e[0],
                      e.forEach(function (t) {
          ...
          var Qd = function () {
            function t(t, e) {
              ...
              this._labeledDescriptors = n.map(function (t) {
                ...
                if (t instanceof Float32Array) return new yf(o(), [
                  t
                ]);
                if (t.descriptor && t.descriptor instanceof Float32Array) return new yf(o(), [
                  t.descriptor
                ]);
